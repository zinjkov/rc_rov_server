...
void rov::horizontal_regulator::apply(rov_types::rov_hardware_control &thruster, const rov_types::rov_control &rc,
    ...
    thruster.horizontal_power[0] = constrain(rc.axis_y + rc.axis_y + rc.axis_w);
    thruster.horizontal_power[1] = constrain(rc.axis_y - rc.axis_y - rc.axis_w);
    thruster.horizontal_power[2] = constrain(rc.axis_y - rc.axis_y + rc.axis_w);
    thruster.horizontal_power[3] = constrain(rc.axis_y + rc.axis_y - rc.axis_w);
